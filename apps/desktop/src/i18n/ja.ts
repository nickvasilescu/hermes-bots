...
export const ja = defineLocale({
  ...
  install: {
    ...
    applyRemote: '適用して再接続',
    backToSetup: '戻る',
    sshOnlySetupTitle: '既存の Hermes に SSH で接続',
    sshOnlySetupDesc: '管理者が用意した鍵と known-hosts を使い、Mini の数値 Tailscale アドレスに接続します。',
    sshOnlyHostTitle: 'Mini Tailscale IP',
    sshOnlyHostDesc:
      '固定の数値 Tailscale IPv4 または IPv6 アドレスを入力してください。DNS 名と SSH エイリアスは使えません。',
    sshOnlyUserTitle: 'SSH ユーザー',
    sshOnlyPortTitle: 'SSH ポート',
    sshOnlyIdentityTitle: '秘密鍵ファイル',
    sshOnlyIdentityDesc: '隔離ランチャーが提供する固定の読み取り専用パスです。',
    sshOnlyHermesPathTitle: 'リモート Hermes パス（任意）',
    sshOnlyProfileTitle: 'リモートプロファイル（任意）',
    sshOnlyTestConnection: 'SSH 接続を検証',
    sshOnlyConnect: '保存して接続',
    sshOnlyTestFirst: '保存する前に SSH 接続を検証してください。',
    sshOnlyTestSucceeded: (host, platform) => `${host}${platform ? ` (${platform})` : ''} を検証しました。`,
    sshOnlyTestFailed: 'SSH の検証に失敗しました。',
    sshOnlyHostKeyChanged: 'Mini のホスト鍵が管理者確認済みの鍵と一致しません。',
    sshOnlyHostKeyUnknown: '管理対象 known-hosts にこの Mini アドレスの鍵がありません。自動的には信頼しません。',
    sshOnlyKnownHostsMissing: '/run/korgo-ssh/known_hosts に管理対象 known-hosts がありません。',
    sshOnlyKnownHostsUnsafe: '管理対象 known-hosts が安全な通常ファイルではありません。',
    sshOnlyIdentityMissing: '/run/korgo-ssh/identity に SSH 秘密鍵がありません。',
    sshOnlyIdentityUnsafe: 'SSH 秘密鍵が所有者管理の安全な通常ファイルではありません。',
    sshOnlyAuthFailed: 'Mini が固定 SSH 鍵を拒否しました。公開鍵の許可を確認してください。',
    sshOnlyTimeout: 'SSH 検証がタイムアウトしました。Mini と Tailscale の状態を確認してください。',
    sshOnlyUnreachable: 'Mini に SSH 接続できません。Tailscale IP、ポート、接続状態を確認してください。',
