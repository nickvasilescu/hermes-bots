...
export const zh: Translations = {
  ...
  rightSidebar: {
    ...
    desktop: {
      ...
      setupDescription: '将每个客户代理绑定到各自的 Orgo 工作区和电脑。Orgo API 密钥会加密保存在操作系统的凭据存储中。',
      agent: '客户代理 / 子账户',
      agentPlaceholder: '搜索代理…',
      agentIsolation: '每个代理都有独立的 Hermes 记忆、会话、工具和电脑凭据。',
      switchingAgent: '正在切换代理…',
      noAgents: '未找到代理。',
      workspace: 'Orgo 工作区',
      workspacePlaceholder: '搜索工作区…',
      findWorkspaces: '查找工作区',
      findingWorkspaces: '正在查找工作区…',
      noWorkspaces: '未找到工作区。',
      loadInventory: '加载可访问的电脑',
      loadingInventory: '正在加载 Orgo 电脑…',
      refreshInventory: '刷新可访问的电脑',
      searchInventory: '搜索电脑或工作区…',
      inventoryScopeHint: '访问范围由 Orgo 控制：账户级密钥显示拥有或共享的工作区；工作区级密钥只显示其工作区。',
      inventorySummary: (workspaces, computers) => `${workspaces} 个工作区 · ${computers} 台电脑`,
      inventoryMatches: count => `${count} 个匹配项`,
      inventoryListLabel: '可访问的 Orgo 电脑',
      computer: 'Orgo 电脑',
      computerPlaceholder: '搜索电脑…',
      noComputers: '未找到电脑。',
      sharedComputer: profile => `${profile} 正在使用共享的默认电脑。请选择其他工作区和电脑以实现隔离。`,
      useSharedComputer: '使用共享的默认电脑',
