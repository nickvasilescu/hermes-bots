...
export const en: Translations = {
  ...
  rightSidebar: {
    ...
    desktop: {
      ...
      setupDescription:
        "This connection is shared across agents by default. Configure an agent only when it needs a different computer. Your Orgo API key stays encrypted in your operating system's credential store.",
