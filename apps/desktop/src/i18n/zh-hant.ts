...
export const zhHant = defineLocale({
  ...
  install: {
    ...
    applyRemote: '套用並重新連線',
    backToSetup: '返回',
    sshOnlySetupTitle: '透過 SSH 連線現有 Hermes',
    sshOnlySetupDesc: '使用維運管理的身分與 known-hosts 檔案，透過 Mini 的數字 Tailscale 位址連線。',
    sshOnlyHostTitle: 'Mini Tailscale IP',
    sshOnlyHostDesc: '輸入穩定的數字 Tailscale IPv4 或 IPv6 位址。不接受 DNS 名稱或 SSH 別名。',
    sshOnlyUserTitle: 'SSH 使用者',
    sshOnlyPortTitle: 'SSH 連接埠',
    sshOnlyIdentityTitle: '身分檔案',
    sshOnlyIdentityDesc: '隔離啟動器提供的固定唯讀路徑。',
    sshOnlyHermesPathTitle: '遠端 Hermes 路徑（選填）',
    sshOnlyProfileTitle: '遠端設定檔（選填）',
    sshOnlyTestConnection: '驗證 SSH 連線',
    sshOnlyConnect: '儲存並連線',
    sshOnlyTestFirst: '儲存前請先驗證 SSH 連線。',
    sshOnlyTestSucceeded: (host, platform) => `已驗證 ${host}${platform ? ` (${platform})` : ''}。`,
    sshOnlyTestFailed: 'SSH 驗證失敗。',
    sshOnlyHostKeyChanged: 'Mini 主機金鑰與維運已驗證的金鑰不符。',
    sshOnlyHostKeyUnknown: '受管 known-hosts 檔案中沒有此 Mini 位址的金鑰；應用程式不會自動信任。',
    sshOnlyKnownHostsMissing: '/run/korgo-ssh/known_hosts 缺少受管 known-hosts 檔案。',
    sshOnlyKnownHostsUnsafe: '受管 known-hosts 不是安全的一般檔案。',
    sshOnlyIdentityMissing: '/run/korgo-ssh/identity 缺少 SSH 身分檔案。',
    sshOnlyIdentityUnsafe: 'SSH 身分檔案不是由擁有者管理的安全一般檔案。',
    sshOnlyAuthFailed: 'Mini 拒絕固定 SSH 身分。請確認對應公開金鑰已授權。',
    sshOnlyTimeout: 'SSH 驗證逾時。請確認 Mini 已喚醒且可透過 Tailscale 存取。',
    sshOnlyUnreachable: '無法透過 SSH 存取 Mini。請檢查 Tailscale IP、連接埠與連線。',
    failedTitle: '安裝失敗',
