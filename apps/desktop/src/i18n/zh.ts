...
export const zh: Translations = {
  ...
  connectors: {
    title: '连接器',
    subtitle: '机器人可以通过 Composio 使用的应用。',
    marketplace: '市场',
    yours: '已连接',
    search: '搜索应用',
    featured: '精选',
    ...
    showMore: '显示更多',
    emptyTitle: '还没有连接器',
    yoursEmpty: '已连接的应用会显示在这里。',
    noMatches: '没有匹配的应用。',
    keyTitle: 'Composio API 密钥',
    keyHelp: '从 Composio → Install 复制 Connect 密钥（以 ck_ 开头）。会通过系统钥匙串加密，永远不会进入对话。',
    keyLabel: 'Composio API 密钥',
    keyPlaceholder: '粘贴 Composio Connect API 密钥（ck_…）',
    keyRequired: '添加 Composio 密钥后即可浏览并连接应用。',
    keySaved: '密钥已保存',
    keyInvalid: '无法验证该 Composio 密钥。',
    getKey: '前往 Composio → Install 获取密钥',
    savingKey: '正在保存密钥…',
    removeKeyTitle: '移除 Composio 密钥？',
    removeKeyHelp: '应用仍会保留在 Composio，但 Hermes 将停止把它们提供给机器人。',
    replaceKeyTitle: '更换 Composio 密钥',
    replaceKeyHelp: '新密钥可能属于另一个 Composio 项目。保存后会重建会话。',
    connectedHelp: '每个机器人都可以使用。',
    loadFailed: '无法加载连接器。',
    connectFailed: '无法连接该应用。',
    disconnectFailed: '无法断开该应用。',
    syncFailed: '无法更新机器人连接器。'
  },
  ...
  install: {
    ...
    applyRemote: '应用并重新连接',
    backToSetup: '返回',
    sshOnlySetupTitle: '通过 SSH 连接现有 Hermes',
    sshOnlySetupDesc: '使用运维管理的身份和 known-hosts 文件，通过 Mini 的数字 Tailscale 地址连接。',
    sshOnlyHostTitle: 'Mini Tailscale IP',
    sshOnlyHostDesc: '输入稳定的数字 Tailscale IPv4 或 IPv6 地址。不接受 DNS 名称或 SSH 别名。',
    sshOnlyUserTitle: 'SSH 用户',
    sshOnlyPortTitle: 'SSH 端口',
    sshOnlyIdentityTitle: '身份文件',
    sshOnlyIdentityDesc: '隔离启动器提供的固定只读路径。',
    sshOnlyHermesPathTitle: '远程 Hermes 路径（可选）',
    sshOnlyProfileTitle: '远程配置（可选）',
    sshOnlyTestConnection: '验证 SSH 连接',
    sshOnlyConnect: '保存并连接',
    sshOnlyTestFirst: '保存前请先验证 SSH 连接。',
    sshOnlyTestSucceeded: (host, platform) => `已验证 ${host}${platform ? ` (${platform})` : ''}。`,
    sshOnlyTestFailed: 'SSH 验证失败。',
    sshOnlyHostKeyChanged: 'Mini 主机密钥与运维已验证的密钥不匹配。',
    sshOnlyHostKeyUnknown: '受管 known-hosts 文件中没有此 Mini 地址的密钥；应用不会自动信任。',
    sshOnlyKnownHostsMissing: '/run/korgo-ssh/known_hosts 缺少受管 known-hosts 文件。',
    sshOnlyKnownHostsUnsafe: '受管 known-hosts 不是安全的常规文件。',
    sshOnlyIdentityMissing: '/run/korgo-ssh/identity 缺少 SSH 身份文件。',
    sshOnlyIdentityUnsafe: 'SSH 身份文件不是由所有者管理的安全常规文件。',
    sshOnlyAuthFailed: 'Mini 拒绝了固定 SSH 身份。请确认对应公钥已授权。',
    sshOnlyTimeout: 'SSH 验证超时。请确认 Mini 已唤醒且可通过 Tailscale 访问。',
    sshOnlyUnreachable: '无法通过 SSH 访问 Mini。请检查 Tailscale IP、端口和连接。',
    failedTitle: '安装失败',
  ...
  rightSidebar: {
    ...
    desktop: {
      ...
      disconnectedUnexpectedly: '电脑连接意外关闭。',
      securityFailure: '电脑拒绝了 VNC 凭据。请重新连接以获取新密码。',
      viewOnly: '仅查看',
      pasteClipboard: '将剪贴板粘贴到电脑',
      clipboardUnavailable: '无法读取本地剪贴板。',
      fullscreen: '全屏打开电脑',
      fullscreenUnavailable: '无法全屏打开电脑。',
      reconnect: '重新连接',
      configure: '配置电脑',
