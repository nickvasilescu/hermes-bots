...
export const ar = defineLocale({
  ...
  install: {
    ...
    sshOnlySetupTitle: 'الاتصال بـ Hermes الحالي عبر SSH',
    sshOnlySetupDesc: 'استخدم ملفات الهوية والمضيفين المُدارة للاتصال بـ Mini عبر عنوان Tailscale الرقمي.',
    sshOnlyHostTitle: 'عنوان Tailscale لجهاز Mini',
    sshOnlyHostDesc: 'أدخل عنوان Tailscale الرقمي الثابت. لا تُقبل أسماء DNS أو الأسماء المستعارة لـ SSH.',
    sshOnlyUserTitle: 'مستخدم SSH',
    sshOnlyPortTitle: 'منفذ SSH',
    sshOnlyIdentityTitle: 'ملف الهوية',
    sshOnlyIdentityDesc: 'مسار ثابت للقراءة فقط يوفره المشغّل المعزول.',
    sshOnlyHermesPathTitle: 'مسار Hermes البعيد (اختياري)',
    sshOnlyProfileTitle: 'ملف التعريف البعيد (اختياري)',
    sshOnlyTestConnection: 'التحقق من اتصال SSH',
    sshOnlyConnect: 'حفظ واتصال',
    sshOnlyTestFirst: 'تحقق من اتصال SSH قبل الحفظ.',
    sshOnlyTestSucceeded: (host, platform) => `تم التحقق من ${host}${platform ? ` (${platform})` : ''}.`,
    sshOnlyTestFailed: 'فشل التحقق من SSH.',
    sshOnlyHostKeyChanged: 'مفتاح مضيف Mini لا يطابق المفتاح الذي تحقق منه المشغّل.',
    sshOnlyHostKeyUnknown: 'ملف المضيفين المُدار لا يحتوي على مفتاح لعنوان Mini هذا. لن يثق به التطبيق تلقائياً.',
    sshOnlyKnownHostsMissing: 'ملف المضيفين المُدار مفقود في /run/korgo-ssh/known_hosts.',
    sshOnlyKnownHostsUnsafe: 'ملف المضيفين المُدار ليس ملفاً عادياً آمناً.',
    sshOnlyIdentityMissing: 'هوية SSH مفقودة في /run/korgo-ssh/identity.',
    sshOnlyIdentityUnsafe: 'هوية SSH ليست ملفاً عادياً آمناً يديره المالك.',
    sshOnlyAuthFailed: 'رفض Mini هوية SSH الثابتة. تحقق من تفويض مفتاحها العام لهذا المستخدم.',
    sshOnlyTimeout: 'انتهت مهلة التحقق من SSH. تحقق من أن Mini متاح عبر Tailscale.',
    sshOnlyUnreachable: 'تعذر الوصول إلى Mini عبر SSH. تحقق من عنوان Tailscale والمنفذ.',
