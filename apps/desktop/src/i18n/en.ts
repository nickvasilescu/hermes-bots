...
export const en: Translations = {
  ...
  connectors: {
    title: 'Connectors',
    subtitle: 'Apps your bots can use through Composio.',
    ...
    add: 'Connect',
    connect: 'Connect',
    composioReady: 'Composio is connected',
    ...
    keySaved: 'Key saved',
    keyInvalid: 'That Composio key could not be verified.',
    ...
    connectFailed: 'Could not connect that app.',
    disconnectFailed: 'Could not disconnect that app.',
    syncFailed: 'Could not update bot connectors.'
  },
  ...
  rightSidebar: {
    ...
    desktop: {
      ...
      disconnectedUnexpectedly: 'The computer connection closed unexpectedly.',
      securityFailure: 'The computer rejected the VNC credentials. Reconnect to request a fresh password.',
      viewOnly: 'View only',
      pasteClipboard: 'Paste clipboard into computer',
      clipboardUnavailable: 'Could not read the local clipboard.',
      fullscreen: 'Open computer fullscreen',
      fullscreenUnavailable: 'Could not open the computer fullscreen.',
      reconnect: 'Reconnect',
      configure: 'Configure computer',
      screenAria: 'Orgo computer screen',
      setupTitle: 'Connect an Orgo computer',
      setupDescription:
        "Bind each client agent to its own Orgo workspace and computer. Your Orgo API key stays encrypted in your operating system's credential store.",
      agent: 'Client agent / sub-account',
      agentPlaceholder: 'Search agents…',
      agentIsolation: 'Each agent keeps separate Hermes memory, sessions, tools, and computer credentials.',
      switchingAgent: 'Switching agent…',
      noAgents: 'No agents found.',
      workspace: 'Orgo workspace',
      workspacePlaceholder: 'Search workspaces…',
      ...
      sharedComputer: profile =>
        `${profile} is using the shared default computer. Choose another workspace and computer to isolate it.`,
      useSharedComputer: 'Use shared default computer',
      computerId: 'Orgo computer ID',
  ...
  assistant: {
    thread: {
      ...
      restoreCheckpoint: 'Return to checkpoint',
